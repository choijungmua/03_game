...
describe("낚시 가방", () => {
  it("포만감을 표시하고, 사과만 먹일 수 있으며 배가 가득 차면 먹이 버튼을 막는다", () => {
    ...
    const { rerender } = render(
      <FishBag inventory={{ 메기: 1, 사과: 2 }} satiety={{ value: 100, at: Date.now() }} affection={37} onFeed={onFeed} />,
    );
    ...
    rerender(<FishBag inventory={{ 메기: 1, 사과: 2 }} satiety={{ value: 0, at: Date.now() }} affection={37} onFeed={onFeed} />);
